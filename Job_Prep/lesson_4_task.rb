# METHOD 1
# it iterates over the ray array and counts the values for which you return true, and are greater than 1
# then the reject method creates a new array without the duplicate elements and returns the new array
def method(array)
